...
export default async function MoviePage({searchParams}) {
    ...
    const settings = {
        ...
        Directors: include?.includes('directors') || false,
        Budget: include?.includes('budget') || false,
        Revenue: include?.includes('revenue') || false
    };
                ...
                <main className=" flex-1 py-10  px-5 sm:px-10 ">
                    ...
                    <section>
                        ...
                        <nav className="flex space-x-6 text-gray-400 font-medium mb-5">
                            ...
                            <Link href="/movies" className="text-gray-700 dark:text-white font-semibold">Movies</Link>
                        </nav>
                        <Box sx={{
                            bgcolor: '#121212',
                            color: '#fff',
